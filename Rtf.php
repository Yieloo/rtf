...
class Rtf {
	...
	*/  	
	...
	function sendRtf($fileName = "simple") {	
		...
		/*
		 * ATTENTION : lors de la mise à jour de la bibliothèque penser à copier les 3 lignes de code 
		 * ci-dessous et a supprimer ou commenter la ligne header('Expires: 0'); car la valeur nulle n'est 
		 * pas supporté par ZEND
		 */
		//header('Expires: 0');
